...
- (void) encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:self.idNumber forKey:NSStringFromSelector(@selector(userName))];
    [aCoder encodeObject:self.idNumber forKey:NSStringFromSelector(@selector(fullName))];
